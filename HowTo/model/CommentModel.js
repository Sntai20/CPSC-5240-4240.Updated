...
var CommentModel = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        e_1 = _a.sent();
                        console.error("Mongo connection error:", e_1);
                        return [3 /*break*/, 3];
    ...
    CommentModel.prototype.retrieveAll = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var docs, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.model.find().sort({ createdDate: -1 }).exec()];
                    case 1:
                        docs = _a.sent();
                        response.json(docs);
                        return [3 /*break*/, 3];
    ...
    CommentModel.prototype.retrieveByID = function (response, commentId) {
        return __awaiter(this, void 0, void 0, function () {
            var doc, e_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.model.findOne({ commentId: commentId }).exec()];
                    case 1:
                        doc = _a.sent();
                        if (doc) {
                            response.json(doc);
    ...
    CommentModel.prototype.createComment = function (response, data) {
        return __awaiter(this, void 0, void 0, function () {
            var newComment, result, e_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        newComment = new this.model(data);
                    ...
                    case 2:
                        e_4 = _a.sent();
                        console.error(e_4);
                        response.status(400).json({ message: "Error creating comment", error: e_4 });
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
            });
